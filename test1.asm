...
int main(int argc, char *argv[])
{
   ...
   int pid=0;
   pid=fork();
    1015:	e8 b1 02 00 00       	call   12cb <fork>
   if(pid==0){
    101a:	85 c0                	test   %eax,%eax
    101c:	75 12                	jne    1030 <main+0x30>
   test(n+1);
    101e:	83 ec 0c             	sub    $0xc,%esp
    1021:	6a 03                	push   $0x3
    1023:	e8 18 00 00 00       	call   1040 <test>
    1028:	83 c4 10             	add    $0x10,%esp
   //int x=1;
  // printf(1, "address %x\n", &x);
   test(1);
   exit();
    102b:	e8 a3 02 00 00       	call   12d3 <exit>
   }
   wait();
    1030:	e8 a6 02 00 00       	call   12db <wait>
   exit();
    1035:	e8 99 02 00 00       	call   12d3 <exit>
...
00001040 <test>:
{
   ...
   test(n+1);
    104e:	8d 43 01             	lea    0x1(%ebx),%eax
    1051:	50                   	push   %eax
    1052:	e8 e9 ff ff ff       	call   1040 <test>
}
    1057:	89 d8                	mov    %ebx,%eax
   test(n+1);
    1059:	83 c4 10             	add    $0x10,%esp
}
    105c:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    105f:	c9                   	leave  
    1060:	c3                   	ret    
    ...
    139c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    13c9:	0f b6 92 f0 17 00 00 	movzbl 0x17f0(%edx),%edx
...
printf(int fd, char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    15c4:	eb 1a                	jmp    15e0 <printf+0x1a0>
          s = "(null)";
    15c6:	bb e8 17 00 00       	mov    $0x17e8,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1615:	a1 fc 1a 00 00       	mov    0x1afc,%eax
{
    ...
    1636:	73 10                	jae    1648 <free+0x38>
{
  ...
  freep = p;
    ...
    1661:	5b                   	pop    %ebx
  freep = p;
    1662:	a3 fc 1a 00 00       	mov    %eax,0x1afc
}
    1667:	5e                   	pop    %esi
    1668:	5f                   	pop    %edi
    1669:	5d                   	pop    %ebp
  ...
  freep = p;
    168a:	a3 fc 1a 00 00       	mov    %eax,0x1afc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    16b0:	8b 3d fc 1a 00 00    	mov    0x1afc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    16f9:	8b 3d fc 1a 00 00    	mov    0x1afc,%edi
  ...
  return freep;
    1727:	a1 fc 1a 00 00       	mov    0x1afc,%eax
    ...
    1754:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
    1757:	a3 fc 1a 00 00       	mov    %eax,0x1afc
}
    ...
    base.s.ptr = freep = prevp = &base;
    1770:	c7 05 fc 1a 00 00 00 	movl   $0x1b00,0x1afc
    1777:	1b 00 00 
    base.s.size = 0;
    177a:	bf 00 1b 00 00       	mov    $0x1b00,%edi
    base.s.ptr = freep = prevp = &base;
    177f:	c7 05 00 1b 00 00 00 	movl   $0x1b00,0x1b00
    1786:	1b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
